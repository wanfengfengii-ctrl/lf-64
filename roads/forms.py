...
class OpenScheduleForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'open_time', 'close_time', 'max_capacity', 'time_slot_minutes',
            'slot_max_capacity', 'is_active', 'description'
        ]
        widgets = {
            'road_section': forms.Select(attrs={'class': 'form-control'}),
            ...
            'time_slot_minutes': forms.NumberInput(attrs={'class': 'form-control', 'min': '1'}),
...
class TemporaryControlForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            'road_section', 'control_type', 'open_status', 'reason', 'start_time',
            'end_time', 'adjusted_capacity', 'adjusted_open_time', 'adjusted_close_time',
        ...
        widgets = {
            ...
            'adjusted_capacity': forms.NumberInput(attrs={'class': 'form-control', 'min': '0'}),
